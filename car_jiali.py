...
class Car(object):
    ...
    def __init__(self):
        ...
        # 构建cookie，并填入header
        co1 = "WEE_SID=ezZct0pYzA-KxUOSXkd_03hE9dMQde4SkuMRcGSHMqUZ2utJzUkb!-1960324086!1998056588!1534858840664;"
        co2 = "IS_LOGIN=true; wee_username=ZnRmdDEwMA==; wee_password=MTIzNDU2Nzg5YWE=;"
        co3 = "JSESSIONID=ezZct0pYzA-KxUOSXkd_03hE9dMQde4SkuMRcGSHMqUZ2utJzUkb!-1960324086!1998056588;"
    ...
    def loadData(self):
        ...
        total = [34,492,797,13,744,205,188,1606]
    ...
    def loadproxy(self):
        file = r'F:\project\pythonPro\tt-master\proxies.txt'
        proxy_list = []
        dict = {}
